...
;(() => {
  ...
  const DEFAULTS = {
    ...
    /**
     * Что вычищаем из пузыря перед чтением текста. Часы и галочки доставки
     * лежат внутри того же блока, и наивный textContent склеил бы их с
     * сообщением («перезвоните16:04») — ровно та ошибка, которую мы уже ловили
     * и в Telegram, и в MAX.
     */
    junk: [
      "[data-pre-plain-text] > span:last-child",
      "[data-icon^='msg-']",
      "[aria-label*='Переслано']",
