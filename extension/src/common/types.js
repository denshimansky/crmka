 ...
 * @property {"group"|"no-messages"|null} [unsupported] Чат открыт, но панель его
 ...
 *
 *   «no-messages» — только WhatsApp: там идентификатор чата берётся из
 *   разметки САМИХ СООБЩЕНИЙ (другого места, где он выводится, в разметке нет),
 *   и в пустом диалоге его взять неоткуда. Это не поломка и не «чат не выбран»,
 *   а третье состояние, и назвать его надо своими словами.
 */
