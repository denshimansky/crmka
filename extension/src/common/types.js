 ...
 * @property {"group"|null} [unsupported] Чат открыт, но панель его не обслуживает.
 *   Сегодня это только групповые чаты MAX (отрицательный id): привязка группы к
 *   клиенту не рабочий сценарий, а цена ошибки необратима — вся групповая
 *   переписка чужих родителей уедет в карточку одного человека. Прятать такой
 *   чат нельзя: панель обязана объяснить, почему карточки здесь нет, иначе
 *   человек прочитает молчание как поломку.
 */
