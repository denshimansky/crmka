...
| PORT-02 | ЛК клиента: расписание, баланс, оплата | MVP | DONE | Честный статус: v1 (/portal, magic link) была без онлайн-оплаты — прежний DONE был завышен в части «оплата». 19.07.2026 оплата исключена из скоупа решением владельца; кабинет переработан в v2: /p/<слаг>, парольный вход (телефон + пароль от партнёра), разрез по подопечным, посещения, история, гейт 6 согласий. DONE в новом объёме (без оплаты) |
