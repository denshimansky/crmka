-- =============================================================================
-- ОБЕЗЛИЧИВАНИЕ ФИО В ДЕМО-БАЗЕ «Детский центр „Умные дети“» (17.07.2026)
-- Продолжение app/scripts/demo-clone-dream-to-sokolova.sql.
--
...
DECLARE
  ...
  salt  constant text := 'demo-clone-2026-07-17';                -- соль ремапа id из скрипта клонирования
