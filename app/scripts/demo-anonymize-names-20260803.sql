-- =============================================================================
-- ОБЕЗЛИЧИВАНИЕ ФИО В ДЕМО-БАЗЕ «Детский центр „Умные дети“» (03.08.2026)
-- Продолжение app/scripts/demo-reclone-dream-to-umnye-deti-20260803.sql.
--
...
DECLARE
  ...
  salt  constant text := 'demo-clone-2026-08-03';                -- соль ремапа id из скрипта клонирования
