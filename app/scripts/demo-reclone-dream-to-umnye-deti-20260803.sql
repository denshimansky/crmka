-- =============================================================================
-- ПОВТОРНОЕ ПЕРЕСОЗДАНИЕ ТЕСТОВОЙ ДЕМО-БАЗЫ (03.08.2026)
--
...
-- Откат после COMMIT: восстановить из бэкапа pre-demo-clone-20260803.dump
-- =============================================================================
...
$fn$ SELECT md5(u::text || 'demo-clone-2026-08-03')::uuid $fn$;
...
DECLARE
  ...
  skip_tables constant text[] := ARRAY[
    ...
    '_bak_employees_20260802_authfix','_bak_relink_oneoff','_bak_relink_w',
    '_fix_easy_salary_adj_bkp_20260731','_fix_easy_salary_bkp_20260731','_fix_easy_salary_items_bkp_20260731',
    'backup_client_branches_20260722','bak_demo_sokolova_branches_20260720','bak_demo_sokolova_employees_20260720'];
