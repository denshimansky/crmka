...
const reportGroups: ReportGroup[] = [
  {
    ...
    columns: [
      ...
      [
        { name: "Воронка продаж", href: "/reports/crm/funnel", description: "Заявки по этапам за месяц: лиды/база, с пробным/без, детализация", source: "clients" },
        { name: "Сводная таблица воронки продаж", href: "/reports/crm/funnel-summary", description: "Снимок «на сейчас»: активные заявки по этапам в разрезе филиалов и направлений + «Связь»", source: "clients" },
      ...
      [
        ...
        { name: "Детализация пробников", href: "/reports/crm/trial-details", description: "Все пробные за месяц с инструктором, статусом, датой посещения", source: "trials" },
  ...
  },
  {
    ...
    reports: [
      ...
      { name: "Сводный по абонементам по инструкторам", href: "/reports/crm/subscriptions-by-instructor", description: "Активные, новые, выбывшие абонементы по инструкторам", source: "subscriptions" },
      { name: "Конверсия пробных по инструкторам", href: "/reports/crm/trial-conversion", description: "Пробные → клиенты по инструкторам", source: "trials" },
    ],
  },
  {
  ...
  },
  {
    ...
    reports: [
      ...
      { name: "Сводный по инструкторам", href: "/reports/salary/by-instructor", description: "Занятия, ученики, ЗП по инструкторам", source: "attendance" },
  ...
  {
    title: "Зарплата и инструкторы",
    icon: Wallet,
    color: "text-amber-600",
    reports: [
      { name: "Сколько денег приносит инструктор", href: "/reports/salary/instructor-profitability", description: "Прибыльность инструктора: выручка − ЗП − расходы", source: "attendance" },
      ...
      { name: "Часы инструкторов по дням", href: "/reports/salary/instructor-hours", description: "Отработанные часы за месяц по инструкторам", source: "lessons" },
