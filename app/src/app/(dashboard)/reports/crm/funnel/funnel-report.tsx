          ...
          <TabsContent key={tab} value={tab} className="mt-4">
            ...
            {tab === "new" && (
              <p className="mt-3 text-xs text-muted-foreground">
                Этап «Лид» — контакты, ставшие лидом (вошедшие в статус «Новый») в
                этом месяце, каждый один раз; если лид за месяц уже перешёл в актив/
                потенциал — он остаётся в счёте. У лида ещё нет заявки, поэтому цифра
                одинакова в обеих схемах.
              </p>
            )}
          </TabsContent>
        ))}
