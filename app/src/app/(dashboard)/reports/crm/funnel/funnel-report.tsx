          ...
          <TabsContent key={tab} value={tab} className="mt-4">
            ...
            {tab === "new" ? (
              <p className="mt-3 text-xs text-muted-foreground">
                «Лиды» — контакты со статусом «Лид» (ещё не покупали и не помечены
                «Потенциал»/«Не целевой»); первая покупка лида (лид→купил) остаётся здесь.
                Этап «Лид» — контакты, ставшие лидом (вошедшие в статус «Новый») в этом
                месяце, каждый один раз; если лид за месяц уже перешёл в актив/потенциал —
                он остаётся в счёте. Лиды разложены по блокам: «с пробным» — у лида есть
                назначенное/посещённое пробное, иначе «без пробного».
              </p>
            ) : (
              <p className="mt-3 text-xs text-muted-foreground">
                «База» — заявки контактов, которые уже покупали (действующие клиенты и
                возвраты выбывших), а также помеченных «Потенциал»/«Не целевой»/«Архив»/
                «Чёрный список». Этапа «Лид» здесь нет.
              </p>
            )}
          </TabsContent>
        ))}
