 ...
 *
 * Страница была СОЗНАТЕЛЬНО скрыта, пока расширение не раздавалось партнёрам:
 * ни плитки в /settings, ни пункта меню — только прямая ссылка. 02.09.2026
 * расширение опубликовано в Chrome Web Store (unlisted), плитка «Расширение для
 * мессенджеров» открыта в settings/page.tsx. Видят её все, у кого settings.view,
 * то есть и администратор — он же и есть главный пользователь панели.
 *
