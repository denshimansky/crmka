    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Праздничные и нерабочие дни. Занятия в эти дни пропускаются при генерации и копировании.
          Если изменить день уже после создания расписания — занятия дня удаляются или воссоздаются,
          а абонементы пересчитываются (переплата возвращается на баланс клиента, недоплата — в долг).
        </p>
      </div>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              Если расписание уже создано, смена состояния удалит или воссоздаст
              занятия дня и пересчитает абонементы.
            </DialogDescription>
          </DialogHeader>
