      ...
      <Card className="max-w-3xl">
        <CardContent className="divide-y p-0">
              ...
              <>
                ...
                <ol className="mt-1 list-decimal space-y-1 pl-5">
                  <li>
                    ...
                    Обязательны «Ребёнок», «Статус» (Статус — состояние клиента в базе:
                    Выбывшие, Потенциал, Архив, Чёрный список, Нецелевой) и контакт —
                    телефон или соцсети. Филиал — заполняется так же, как создали
                    филиалы в новой CRM.
                  </li>
                  <li>
                    ...
                    одному родителю и создаст столбец «Проверить», где напротив строки,
                    которую надо проверить, будет стоять «Да». Возможные причины:
                    спорное имя, некорректный телефон, нет контакта (ни телефона, ни
                    соцсетей), пустой или непонятный статус, в имени родителя только
                    инициалы или одна фамилия без имени.
                  </li>
                  <li>
                    Система сразу <span className="font-medium">скачает вам
                    проверенный файл</span>. Откройте его в Excel, поправьте строки с
                    пометкой «Проверить = Да», удалите все «Да» и сохраните.
                  </li>
                  <li>
          ...
          <ImportRow
            ...
            description="Скачайте шаблон остатков, заполните два столбца — Телефон и Баланс на сегодня — и загрузите. Один клиент — одна строка (один телефон): если один и тот же телефон попадёт в несколько строк, их балансы СЛОЖАТСЯ (задвоятся). Баланс каждого клиента ставится ровно к значению из файла по телефону (+ депозит, − долг). Клиенты не создаются, в ДДС не пишется, повторная загрузка того же файла ничего не меняет."
            button={
              <div className="flex flex-col gap-2">
                <SyncBalancesButton />
