          ...
          <DialogHeader>
            ...
            <DialogDescription className="space-y-2">
              ...
              <span className="block">
                <b>Один клиент — одна строка</b> (один телефон). Если один и тот же
                телефон встретится в нескольких строках, их балансы <b>сложатся</b> —
                клиент получит задвоенную сумму.
              </span>
              <span className="block">
