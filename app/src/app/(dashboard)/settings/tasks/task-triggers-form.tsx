    ...
    <Card>
      <CardContent className="space-y-4 p-6">
        <div className="flex items-start gap-3 rounded-md bg-muted/40 p-3 text-sm text-muted-foreground">
          ...
          <p>
            Автоматические задачи создаются раз в сутки (рано утром), а также вручную
            кнопкой «Автозадачи» в разделе «Задачи». Здесь можно временно выключить
            отдельные триггеры или ограничить их работу определённым диапазоном дней
            месяца (например, напоминать об оплате только с 5-го числа).
          </p>
        </div>
