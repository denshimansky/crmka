        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {insufficient && (
            <div className="text-xs text-muted-foreground">
              На балансе родителя нет средств. Сначала оформите поступление в
              «Финансы → Оплаты» — деньги попадут в кошелёк родителя, затем
              вернитесь сюда и спишите нужную сумму в счёт абонемента.
            </div>
          )}
