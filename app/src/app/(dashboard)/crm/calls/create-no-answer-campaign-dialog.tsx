 ...
 * прозвонить их одним списком. Дальше, как у обзвона по базам, внутри кампании
 * работает кнопка «Актуализировать» — она дотягивает новые «не ответившие» и
 * убирает тех, кого с тех пор уже дозвонили.
 */
