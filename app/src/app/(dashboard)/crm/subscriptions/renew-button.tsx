        ...
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              ребёнка, у которого есть <b>активный</b> или <b>закрытый за прошлый
              месяц</b> календарный абонемент (отчисленные не продлеваются).
              Цена занятия — по актуальному прайсу направления, число занятий считается по
              расписанию группы за указанный период (с учётом производственного календаря).
              Скидки пересчитаются автоматически после выписки.
            </DialogDescription>
          </DialogHeader>
