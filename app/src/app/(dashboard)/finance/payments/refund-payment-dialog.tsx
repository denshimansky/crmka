...
export function RefundPaymentDialog({
  ...
  function handleShowConfirm(e: React.FormEvent) {
    ...
    if (!amount || Number(amount) <= 0) { setError("Укажите сумму возврата"); return }
    if (!method) { setError("Выберите способ возврата"); return }
        ...
        {step === "form" ? (
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-md border border-red-200 bg-red-50 p-4 space-y-2 text-sm dark:border-red-900/50 dark:bg-red-950/30">
              <p className="font-medium text-red-800 dark:text-red-300">Подтвердите возврат средств:</p>
              <div className="space-y-1">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-red-600">-{formatMoney(Number(amount))}</span>
                </div>
                <div className="flex justify-between">
            ...
            <DialogFooter className="gap-2">
              ...
              <Button variant="destructive" onClick={handleSubmit} disabled={loading}>
                {loading ? "Оформление..." : "Подтвердить возврат"}
              </Button>
            </DialogFooter>
          </div>
        )}
