...
function SettingsTab({
  ...
  // Итог перестройки расписания словами. Перестройку запускает только смена дат
  // старта/окончания группы (PATCH отдаёт её результат в поле regen, при
  // сохранении прочих полей его нет), а удаление занятий в ней бесследно — ни
  // архива deleted_lessons, ни записи в истории, поэтому единственное место,
  // где администратор об этом узнаёт, — вот это сообщение.
