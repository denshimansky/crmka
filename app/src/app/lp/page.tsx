...
const faq = [
  {
    ...
    a: "Умная CRM создана специально для детских центров и сферы услуг. Абонементы, расписание, lesson card, зарплата инструкторам — всё из коробки, без интеграторов.",
  },
  {
