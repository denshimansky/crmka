  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        formula: "Прогноз прибыли = Сумма абонементов − Прогноз ЗП педагогов − Прогноз переменных расходов − Прогноз постоянных платежей. Прогноз ЗП — авто (расписание × ставки). Перемен. — среднее по статье канцтоваров. Постоян. — вручную (план)",
        status: "ok",
      },
      {
        id: "FIN-14",
