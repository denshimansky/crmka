    ...
    reports: [
      {
        ...
        formula: "COUNT по этапам: Лиды → Записались на пробное → Пришли на пробное → Совершено продаж → Внесли оплату. Два блока: «текущий месяц» (по дате создания абонемента) + «перетекающие» (созданы ранее, действие в текущем месяце)",
        status: "ok",
      },
      {
        id: "CRM-14",
