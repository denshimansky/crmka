...
const releases: Release[] = [
  {
    version: "1.5.8-alpha",
    date: "28.05.2026",
    title: "ЛК клиента: кнопка генерации ссылки + фикс добавления ученика",
    changes: [
      ...
      { type: "fixed", text: "Backend POST /api/lessons/[id]/add-student: wardId стал обязательным параметром" },
    ],
  },
  {
    version: "1.5.7-alpha",
