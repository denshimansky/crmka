...
const modules: RoadmapModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "SAL-14", text: "История оклада: изменения «с даты», прошлые месяцы не пересчитываются", status: "done" },
      { id: "SAL-12", text: "Расширенные схемы ставок: процент, плавающая матрица, ставка на группу", status: "done" },
      { id: "SAL-13", text: "Откат выплаченных отметок: переплата уходит в «Доначислено» следующего месяца (авто-премия убрана 22.08.2026)", status: "done" },
