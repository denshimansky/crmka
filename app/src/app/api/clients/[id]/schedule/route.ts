...
export async function GET(
  ...
  // Без фильтра по дате — показываем все ещё не отмеченные пробные, включая
  // те, у которых дата уже прошла (админ забыл проставить статус): иначе
  // запись «зависает» в БД и её невозможно найти через UI.
