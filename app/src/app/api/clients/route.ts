...
const createSchema = z.object({
  ...
  telegram: z.any().transform(v => (typeof v === "string" && v.trim()) ? v.trim() : undefined),
  vk: z.any().transform(v => (typeof v === "string" && v.trim()) ? v.trim() : undefined),
  max: z.any().transform(v => (typeof v === "string" && v.trim()) ? v.trim() : undefined),
