...
export const config = {
  matcher: [
    "/((?!login|offer|lp|forgot-password|reset-password|roadmap|changelog|dev|admin|portal|api/auth|api/admin|api/portal|_next/static|_next/image|favicon.ico|manifest|sw|icons).*)",
  ],
}
