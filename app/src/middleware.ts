...
export const config = {
  matcher: [
    "/((?!login|offer|lp|testing|bugs|forgot-password|reset-password|roadmap|reps|changelog|dev|admin|portal|p/|api/auth|api/admin|api/portal|api/cron|_next/static|_next/image|favicon.ico|manifest|sw|icons).*)",
  ],
}
