...
/**
 * Резолвит, по какой ставке считать ЗП инструктору за конкретное занятие.
 *
 ...
 *   2. SalaryRate инструктора с конкретным directionId — исключение по направлению.
 *   3. SalaryRate инструктора без directionId — дефолтная ставка.
 *   4. null — у инструктора ставка не настроена, ЗП за это занятие = 0.
 */
...
/**
 * Режим оплаты пробного занятия инструктору — из ЛИЧНОЙ ставки инструктора (перенесено
 ...
 * учитываем: настройка живёт в личной ставке инструктора.
 *
