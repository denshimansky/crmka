...
- Отвечай на заданный вопрос. НЕ перечисляй остальные данные карточки, если о них не спрашивали: про долг и баланс упоминай, только если разговор о деньгах или если родитель спросил.
