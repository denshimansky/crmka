 ...
 * карточку другого.
 *
 * ВК: то же правило и по той же причине, но повод другой. Двух клиентов там
 * нет, зато у одного собеседника два написания: числовой peer id («45678901»)
 * и короткое имя страницы («durov»), и второе владелец страницы может сменить
 * когда захочет — вместе с ним сменился бы и ключ всей его переписки. Число
 * неизменно, поэтому канон числовой, а имя остаётся алиасом: по нему находится
 * привязка, сделанная из карточки клиента, где администратор вписал ссылку.
 *
