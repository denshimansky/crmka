      ...
      {block.type === "text" && (
        <div className="space-y-2">
          ...
          <Textarea
            ...
            disabled={!canEdit}
            rows={4}
            placeholder="Текст. Поддерживается **жирный**, *курсив*, __подчёркнутый__, `код`. Ссылки кликабельны сами по себе — вставьте адрес как есть; чтобы подписать ссылку, [текст](адрес). Enter — перенос строки, пустая строка — новый абзац."
          />
        </div>
      )}
