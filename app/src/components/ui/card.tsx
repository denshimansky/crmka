...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Без overflow-hidden — он ломал горизонтальный скролл внутренних
        // таблиц (<Table> уже обёрнут в overflow-x-auto). Изображения,
        // прижатые к краям карточки, продолжают скругляться через селекторы
